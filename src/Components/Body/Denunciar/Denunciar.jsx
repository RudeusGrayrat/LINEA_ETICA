...
const Denunciar = () => {
    ...
    return (
        <>
            <div
                className="bg-white border-2 rounded-4xl shadow-2xl p-4 w-[24%] max-md:w-[40%] h-[31vh] max-sm:w-[50%] flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all duration-300"
